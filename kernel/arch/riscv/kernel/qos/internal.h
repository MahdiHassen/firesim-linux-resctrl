...
struct cbqri_resctrl_dom {
	/* v6.2 backport: Morse's tree has a unified rdt_domain — Drew's
	 * upstream-targeted code expects the later split into hdr/ctrl/mon.
	 * Collapsed to one field; container_of() callers all rename to
	 * resctrl_dom. */
